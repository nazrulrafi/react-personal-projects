...
function Footer(props) {
    return (
        <div className='text-gray-500/80 pt-8 px-6 md:px-16 lg:px-24 xl:px-32'>
            <div className='flex flex-wrap justify-between gap-12 md:gap-6 max-w-[1450px] mt-15 px-10 mx-auto'>
            ...
            <div className='flex flex-col md:flex-row gap-2 items-center justify-between py-5 max-w-[1450px] px-10 mx-auto'>
                <p>© {new Date().getFullYear()} <a href="https://prebuiltui.com">PrebuiltUI</a>. All rights reserved.
                </p>
