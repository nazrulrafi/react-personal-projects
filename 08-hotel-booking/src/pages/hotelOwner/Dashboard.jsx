        ...
        <div>
            ...
            <div className="flex gap-4 my-8">
                <div className="bg-primary/3 border border-primary/10 rounded flex p-4 pr-8">
                    <img className="max-sm:hidden h-10" alt="" src={assets.totalBookingIcon}/>
                ...
                <div className="bg-primary/3 border border-primary/10 rounded flex p-4 pr-8">
                    <img className="max-sm:hidden h-10" alt="" src={assets.totalRevenueIcon}/>
                    <div className="flex flex-col sm:ml-4 font-medium">
                        ...
                        {dashboardData.bookings.map((item, index) => (
                            <tr key={index}>
                                ...
                                <td className="py-3 px-4  border-t border-gray-300 flex">
                                    <button className={`py-1 px-3 text-xs rounded-full mx-auto ${item.isPaid ? "bg-green-200 text-green-600" :"bg-amber-200 text-yellow-500"}`}>{item.isPaid ? "Completed" : "Pending"}</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
