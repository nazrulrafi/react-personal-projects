...
function Team(props) {
    return (
        <motion.div
            ...
            <Title title="Meet the team" description="A passionate team of digital experts dedicated to your brands
            success."/>
            <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-5">
                {teamData.map((team,index)=> (
                    <motion.div
                        ...
                        <img className="w-12 h-12 rounded-full" alt="" src={team.image}/>
