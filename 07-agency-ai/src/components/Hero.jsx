    ...
    return (
        <div id="hero" className="flex flex-col items-center gap-6 py-20 px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white">
            <motion.div
                ...
                <img className="w-20" alt="" src={assets.group_profile}/>
            ...
            <motion.div
                ...
                viewport={{once:true}}
                className="relative">
                <img alt="" className="w-full max-w-6xl" src={assets.hero_img}/>
                <img alt="" className="absolute -top-40 -right-40 sm:-top-100 sm:-right-70 -z-1 dark:hidden"
                src={assets.bgImage1}/>
            </motion.div>
        </div>
    );
