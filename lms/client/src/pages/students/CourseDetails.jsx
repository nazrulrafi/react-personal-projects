...
function CourseDetails(props) {
    ...
    return courseData ? (
        <>
            <div
                className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left">
                <div
                    className="absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-cyan-100/70"></div>
                <div className="max-w-xl z-10 text-gray-500">
                    <h1 className="md:text-course-deatails-heading-large text-course-deatails-heading-small font-semibold text-gray-800 text-3xl">{courseData.courseTitle}</h1>
                    ...
                    <div className="py-20 text-sm md:text-default">
                        ...
                        <p className="rich-text pt-3">
                            <h2 className="text-xl text-dark">Deep Dive into Python Programming</h2>
                ...
                <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white max-w-[300px] sm:min-w-[420px]">
                    {
