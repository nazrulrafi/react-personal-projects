...
import HeaderToggleWidget from "./HeaderToggleWidget.jsx";
import logo from "../assets/logo.svg";
function DashboardHeader({setToggleMobileMenu}) {
        ...
        <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 xl:border-b">
            <div className="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
                <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 xl:justify-normal xl:border-b-0 xl:px-0 xl:py-4">
                    <button onClick={()=>setToggleMobileMenu(prevState => !prevState)} className="flex items-center justify-center w-10 h-10 text-gray-500 border-gray-200 rounded-lg z-99999 dark:border-gray-800 dark:text-gray-400 lg:h-11 lg:w-11 xl:border lg:bg-transparent dark:lg:bg-transparent cursor-pointer"
                    ...
                    <a className="xl:hidden" href="/">
                        <img alt="Logo" width="154" height="32" className="dark:hidden" src={logo}/>
                        <img alt="Logo" width="154" height="32" className="hidden dark:block"
                ...
                <div
                    className="hidden items-center justify-between w-full gap-4 px-5 py-4 xl:flex shadow-theme-md xl:justify-end xl:px-0 xl:shadow-none">
                    <div className="flex items-center gap-2 2xsm:gap-3">
                        <button
                            className="relative flex items-center justify-center text-gray-500 transition-colors bg-white border border-gray-200 rounded-full hover:text-dark-900 h-11 w-11 hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white">
                            <svg className="hidden dark:block" width="20" height="20" viewBox="0 0 20 20"
                    ...
                    <div className="relative" ref={dropdownRef}>
                        <button onClick={()=>setToggleWidget(prev=>!prev)} className="flex items-center dropdown-toggle text-gray-700 dark:text-gray-400 dropdown-toggle">
                                    <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
                                        <img alt="User" src={avatar}/>
                                    </span>
                            <span className="block mr-1 font-medium text-theme-sm">Nazrul Rafi</span>
                            <svg className="stroke-gray-500 dark:stroke-gray-400 transition-transform duration-200 "
                        ...
                        {toggleWidget && <HeaderToggleWidget/>}
                    </div>
                </div>
            </div>
        </header>
